...
public class Token {
    ...
    public Token() {
    	Properties integracionProps = HeartbeatController.getIntegracionProps();
        this.client_id = integracionProps.getProperty("peya.heartbeat.usuario.api");
        this.client_secret = integracionProps.getProperty("peya.heartbeat.secret.api");
    }
