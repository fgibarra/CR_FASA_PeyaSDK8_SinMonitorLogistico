...
public class Token {
    ...
    public Token() {
    	Properties integracionProps = PeyaStatus.getIntegracionProps();
        this.client_id = integracionProps.getProperty("peya.status.usuario.api");
        this.client_secret = integracionProps.getProperty("peya.status.secret.api");
    }
